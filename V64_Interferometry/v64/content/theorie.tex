...
\end{equation*}
The amplitudes are sampled at the different locations A and B at a time-difference of $\tau$ and compared as a function of $t$. For the timely coherence the same equation is used with $\text{A} = \text{B}$.
