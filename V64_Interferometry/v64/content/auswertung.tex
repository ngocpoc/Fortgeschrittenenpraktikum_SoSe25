...
For each pressure, the arithmetic mean $\bar{M}$ and the corresponding refractive index $n_{\text{air, 1}}$ were calculated. The results are summarized in \autoref{tab:air}.
\begin{table}[h]
    \centering
...
leads to the refractive indes of air $n_{\text{air, 2}} = 1.0002770\pm0.0000013$.