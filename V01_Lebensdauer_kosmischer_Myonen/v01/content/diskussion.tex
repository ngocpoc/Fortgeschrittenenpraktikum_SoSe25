...
Demnach könnte die Einstellung der Verzögerung als $2 \, \unit{\nano\second}$ nicht ideal gewesen sein. Bei einer nicht ideal eingestellten Verzögerungszeit verringert sich die Pulsrate und mehr Untergund wird gemessen. 
Da sich die eingestellte Verzögerung aber wie in \autoref{fig:Verzoegerung} zu erkennen innerhalb des Plateaus befindet, ist kein erheblicher Einfluss auf die Auswertung zu erwarten.
%Allerdings ist in der \autoref{fig:Verzoegerung} zu erkennen, dass eine Verzögerungszeit innerhalb des gekennzeichneten Plateaus zu keiner signifikanten Änderung der Pulsrate führt.
...
%Eine geringere als ideale Pulsrate würde zu einer erhöhten Messung von Untergrund führen. 
