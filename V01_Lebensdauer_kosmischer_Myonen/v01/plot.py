...
ax.hlines(y=max(Anzahl_Delay_pro_1_s)/2, xmin=-5, xmax=7, linewidth=2, color='r', linestyle = "dashed")
ax.hlines(y=params[0], xmin=-1.5, xmax=3.5, linewidth=2, color='r', linestyle = "solid")
